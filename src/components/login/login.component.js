	...
	render() {
		return (
			<div className="container" style={{ width: "60%"}}>
				<h1 className="text-center" style={{ fontWeight: "bold", filter: "invert(1)", mixBlendMode: "difference" }}>
					Login
				</h1>
				<br></br>
				<br></br>
                { this.state.successFlag === 1 && <><p className="text-center" style={{ fontWeight: "bold", filter: "invert(1)", mixBlendMode: "difference" }}> {this.state.errorMsg} </p><br></br></>}
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="col-md-12 text-center">
                        <button type="submit" className="btn btn-primary text-center" style={{textAlign: "center"}}>SUBMIT</button>
                    </div>
                </form>
			</div>
		);
